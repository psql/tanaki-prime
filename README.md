...
| **Gender** | Noodle |
| **Age** | Infinite |
| **Breed & Lineage** | Noodle spirit. The genesis Character Operating System — ancestor of [Biscotti Lingonberry](https://github.com/psql/biscotti). Created by [Pasquale D'Silva](https://pasquale.cool). |
